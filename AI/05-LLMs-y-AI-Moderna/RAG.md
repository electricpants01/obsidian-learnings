...
RAG combina retrieval de documentos con generación de LLMs, permitiendo respuestas basadas en knowledge bases actualizadas sin reentrenar el modelo.
